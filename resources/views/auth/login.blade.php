            ...
            <div class="bg-white border border-gray-300 shadow-lg rounded-lg p-6 ">
                ...
                <div class="mb-5 sm:mb-8">
                    <div
                        ...
                        <a href="/">
                            <img src="{{ asset('tailadmin/build/src/images/logo/logo-icon.svg') }}"
                                class="w-20 h-20 fill-current text-gray-500" alt="">
                        </a>
                    </div>
                    <h1 class="mb-2 font-semibold text-gray-800 text-title-sm  sm:text-title-md text-center">
                        Sign In
                    </h1>
                ...
                <div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="space-y-5">
                            <!-- Username -->
                            <div>
                                <x-input-label for="username" class="mb-1.5 block text-sm font-medium text-gray-700 "
                                    :value="__('Username')" />
                            ...
                            <!-- Password -->
                            <div>
                                <x-input-label for="password" class="mb-1.5 block text-sm font-medium text-gray-700 "
                                    :value="__('Password')" />
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="text-sm text-brand-500 hover:text-brand-600 "
                            ...
                            <div>
                                <button
                                    class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-blue-500 shadow-theme-xs hover:bg-brand-600">
                                    {{ __('Log in') }}
                                </button>
                            </div>
                        </div>
