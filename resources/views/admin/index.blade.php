<x-app-layout>
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
            ...
            <div class="mt-5 flex items-end justify-between">
                <div>
                    <span class="text-sm text-gray-500">Jumlah kasir saat ini</span>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
            ...
            <div class="mt-5 flex items-end justify-between">
                <div>
                    <span class="text-sm text-gray-500">Jumlah Penjualan</span>
                    <h4 class="mt-2 text-title-sm font-bold text-gray-800">
                        {{ $sale }}
                    </h4>
                </div>
    ...
    <!-- ====== Chart One Start -->
    <div
        class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6 mt-5">
        ...
        <div class="max-w-full overflow-x-auto custom-scrollbar">
            <div class="-ml-5 min-w-[650px] pl-2 xl:min-w-full">
                <div id="saleChart" class="-ml-5 h-full min-w-[650px] pl-2 xl:min-w-full"></div>
            </div>
        </div>
    </div>
    <!-- ====== Chart One End -->
