<x-app-layout>
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: `Edit Kasir` }">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <nav>
                <ol class="flex items-center gap-1.5">
                    <li>
                        <a class="inline-flex items-center gap-1.5 text-sm text-gray-500" href="{{ route('admin.cashier.index') }}">
                            Kasir
            ...
            <div class="p-5 border-t border-gray-100 sm:p-6">
                <form action="{{ route('admin.cashier.update', $cashier->id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" placeholder="Nama" value="{{ old('name', $cashier->name) }}"
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="username" placeholder="username" value="{{ old('username', $cashier->username) }}"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="Password Baru"
