<x-app-layout>
    <!-- Breadcrumb Start -->
    <div x-data="{ pageName: `Tambah Kemasan` }">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li>
                        <a class="inline-flex items-center gap-1.5 text-sm text-gray-500" href="{{ route('admin.packaging.index') }}">
                            List Kemasan
                            <svg class="stroke-current" width="17" height="16" viewBox="0 0 17 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.0765 12.667L10.2432 8.50033L6.0765 4.33366" stroke=""
    ...
    <div class="space-y-5 sm:space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white">
            <div class="p-5 border-t border-gray-100 sm:p-6">
                <form action="{{ route('admin.packaging.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
