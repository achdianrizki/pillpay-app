                ...
                <div class="col-span-6 md:col-span-2 space-y-3">
                    ...
                    <div>
                        ...
                        <select id="filter-kategori" name="category_id"
                            class="focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden">
                            <option value="" disabled {{ old('category_id') ? '' : 'selected' }}>Pilih Kategori Obat
                            </option>
                    ...
                    <div>
                        ...
                        <div x-data="{ isOptionSelected: {{ old('packaging') ? 'true' : 'false' }} }"
                            ...
                            <select
                                ...
                                <option value="" disabled {{ old('packaging_id') ? '' : 'selected' }}>Pilih Kemasan
                                </option>
                                @foreach ($packagings as $packaging)
                                <option value="{{ $packaging->id }}" {{ old('packaging_id') }}>
